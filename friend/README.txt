...
To get this up and running, follow these steps strictly.
...
----------------------
1. The `db.json` file is where your accounts live.
2. It is currently empty. You will add accounts using Discord commands later.
